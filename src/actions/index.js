...
export const CREATE_PERSON_DUPLICATE_SET = 'CREATE_PERSON_DUPLICATE_SET';
...
export const UPDATE_PERSON_VIEW_CELL = 'UPDATE_PERSON_VIEW_CELL';
export const DELETE_PERSON_VIEW = 'DELETE_PERSON_VIEW';
export const REORDER_PERSON_VIEW_COLUMNS = 'REORDER_PERSON_VIEW_COLUMNS';
...
export const RETRIEVE_CALL_ASSIGNMENTS_RECURSIVE = 'RETRIEVE_CALL_ASSIGNMENTS_RECURSIVE';
...
export const DELETE_SURVEY_SUBMISSION = 'DELETE_SURVEY_SUBMISSION';
...
// Actions related to sub-organizations
export const RETRIEVE_SUB_ORGS = 'RETRIEVE_SUB_ORGS';

// Join forms
export const ACCEPT_JOIN_SUBMISSION = 'ACCEPT_JOIN_SUBMISSION';
export const CREATE_JOIN_FORM = 'CREATE_JOIN_FORM';
